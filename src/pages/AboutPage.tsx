...
import { Award, Users, Coffee, Heart, Sparkles, Zap, Search, Pen, Layers, Palette, MousePointerClick, FlaskConical, Crown, Paintbrush, Wand2, ArrowRight } from "lucide-react";
...
const stats = [
  ...
  { icon: Heart, label: "Awards Won", value: "12" },
];
...
const experience = [
  {
    ...
    description: "Leading design initiatives for major clients, managing a team of 3 designers, and establishing design systems.",
  },
  {
    year: "2021 - 2023",
    title: "UX/UI Designer",
    company: "DigitalWave Agency",
    description: "Designed user-centered solutions for web and mobile applications, conducted user research and usability testing.",
  },
  {
    year: "2019 - 2021",
    title: "Junior Designer",
    company: "StartUp Hub",
    description: "Created wireframes, mockups, and prototypes for various startup projects and assisted in branding initiatives.",
  },
];
...
const portfolioProjects = [
  ...
  },
  {
    ...
    skills: ["User Research", "Wireframing", "Prototyping", "Visual Design", "Interaction Design", "Leadership"]
  },
  {
    id: "brandflow",
    ...
    skills: ["Visual Design", "Interaction Design", "Wireframing", "Leadership", "Illustration"]
  },
  {
    id: "foodshare",
    ...
    skills: ["User Research", "Wireframing", "Prototyping", "Visual Design", "Interaction Design", "Usability Testing", "Animation"]
  },
  {
    id: "techstart",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1610989001873-03968eed0f08?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3ZWJzaXRlJTIwZGVzaWduJTIwbW9ja3VwfGVufDF8fHx8MTc2MTEzMzU0Mnww&ixlib=rb-4.1.0&q=80&w=1080",
    skills: ["Wireframing", "Prototyping", "Visual Design", "Interaction Design", "Animation"]
  },
];
...
export function AboutPage({ onNavigate }: AboutPageProps) {
  ...
  const getProjectsForSkill = (skillName: string) => {
    return portfolioProjects.filter(project => project.skills.includes(skillName));
  };
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-[#6B6B8D] mb-6 leading-relaxed">
                  Hi! I'm Sandra Wilmann, a passionate UX/UI designer with over 5 years of experience crafting 
                  beautiful and functional digital experiences. My journey in design started with a simple 
                  curiosity about how things work and evolved into a deep passion for creating intuitive 
                  interfaces that users love.
                </p>
                <p className="text-[#6B6B8D] mb-6 leading-relaxed">
                  I believe that great design is not just about aesthetics—it's about solving real problems 
                  and making people's lives easier. Every project I take on is an opportunity to blend 
                  creativity with functionality, ensuring that the end result is both beautiful and purposeful.
                </p>
                <p className="text-[#6B6B8D] leading-relaxed">
                  When I'm not designing, you'll find me exploring new coffee shops, sketching ideas in my 
                  notebook, or staying up to date with the latest design trends and tools.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-sm text-[#6B6B8D]">{stat.label}</p>
                  </motion.div>
                );
              })}
            </div>
              ...
              {experience.map((exp, index) => (
                ...
                >
                  ...
                  <div className="bg-white/40 backdrop-blur-md rounded-2xl p-6 border border-white/60 shadow-lg hover:shadow-xl transition-all hover:bg-white/50">
                    <div className="text-sm text-[#CD2C58] mb-2">{exp.year}</div>
                    <h3 className="mb-2 text-[#4A4E69]">{exp.title}</h3>
                    <p className="text-sm text-[#9D84B7] mb-3">{exp.company}</p>
                    <p className="text-sm text-[#6B6B8D] leading-relaxed">{exp.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[#4A4E69]">Design Skills</h3>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { name: "User Research", icon: Search, description: "Conducting in-depth user interviews and data analysis to inform design decisions" },
                  { name: "Wireframing", icon: Pen, description: "Creating detailed wireframes and information architecture for seamless user flows" },
                  { name: "Prototyping", icon: Layers, description: "Building interactive prototypes to test and validate design concepts" },
                  { name: "Visual Design", icon: Palette, description: "Crafting beautiful, cohesive visual systems that bring brands to life" },
                  { name: "Interaction Design", icon: MousePointerClick, description: "Designing engaging micro-interactions and animations for delightful experiences" },
                  { name: "Usability Testing", icon: FlaskConical, description: "Running comprehensive testing sessions to optimize user experience" }
                ].map((skill, i) => {
                    ...
                    >
                      ...
                      <div className="relative">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <p className="text-sm text-[#4A4E69] font-semibold">{skill.name}</p>
                        </div>
                        <p className="text-xs text-[#6B6B8D] leading-relaxed mb-3">{skill.description}</p>
                          ...
                          {isExpanded && relatedProjects.length > 0 && (
                            ...
                            >
                              <p className="text-xs text-[#4A4E69] mb-3">
                                Projects where I used {skill.name}:
                              </p>
                                ...
                                {relatedProjects.map((project, idx) => (
                                  ...
                                  >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#CD2C58]/90 to-transparent flex items-end p-3">
                                      <div>
                                        <p className="text-xs text-white">{project.title}</p>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[#4A4E69]">Tools & Software</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-[#4A4E69]">Additional Expertise</h3>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { name: "Leadership", icon: Crown, description: "Mentoring design teams and leading cross-functional collaboration on complex projects" },
                  { name: "Illustration", icon: Paintbrush, description: "Creating custom illustrations and iconography to enhance visual storytelling" },
                  { name: "Animation", icon: Wand2, description: "Designing smooth motion graphics and transitions that bring interfaces to life" }
                ].map((skill, i) => {
                  const SkillIcon = skill.icon;
                  const isExpanded = expandedSkill === skill.name;
                  const relatedProjects = getProjectsForSkill(skill.name);
