        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <a
                href="https://github.com/Swillygoose"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4A4E69] to-[#6B6B8D] flex items-center justify-center text-white hover:shadow-lg transition-shadow"
                aria-label="GitHub"
              >
                <svg
                  className="w-5 h-5"
